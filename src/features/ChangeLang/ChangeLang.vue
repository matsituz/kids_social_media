<template>
  <div class="change-lang">
    ...
    <p class="change-lang__heading">{{ $t("lang.change") }}</p>
    <div class="change-lang__footer">
      <button
        :class="[
          'change-lang__footer-btn',
          {
            'change-lang__footer-btn--active': lang === 'ru',
          },
        ]"
        @click="(langModale = false), changeLang('ru')"
      >
        Русский
      </button>
      <button
        :class="[
          'change-lang__footer-btn',
          {
            'change-lang__footer-btn--active': lang === 'uz',
          },
        ]"
        type="primary"
        @click="(langModale = false), changeLang('uz')"
      >
        O'zbekcha
      </button>
    </div>
